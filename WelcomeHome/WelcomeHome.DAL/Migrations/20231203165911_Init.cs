    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocialPayouts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Steps_EstablishmentTypes_EstablishmentTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocialPayoutUserCategory", x => new { x.SocialPayoutsId, x.UserCategoriesId });
                    table.ForeignKey(
                        name: "FK_SocialPayoutUserCategory_SocialPayouts_SocialPayoutsId",
                        column: x => x.SocialPayoutsId,
                        principalTable: "SocialPayouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SocialPayoutUserCategory_UserCategories_UserCategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Establishments_EstablishmentTypes_EstablishmentTypeId",
                        column: x => x.EstablishmentTypeId,
                        principalTable: "EstablishmentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentSteps", x => new { x.StepId, x.SocialPayoutId });
                    table.ForeignKey(
                        name: "FK_PaymentSteps_SocialPayouts_SocialPayoutId",
                        column: x => x.SocialPayoutId,
                        principalTable: "SocialPayouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentSteps_Steps_StepId",
                        column: x => x.StepId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StepsDocuments", x => new { x.StepId, x.DocumentId });
                    table.ForeignKey(
                        name: "FK_StepsDocuments_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StepsDocuments_Steps_StepId",
                        column: x => x.StepId,
                        principalTable: "Steps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Establishments_EstablishmentId",
                        column: x => x.EstablishmentId,
                        principalTable: "Establishments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Establishments_EstablishmentTypeId",
                table: "Establishments",
                column: "EstablishmentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_EstablishmentId",
                table: "Events",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentSteps_SocialPayoutId",
                table: "PaymentSteps",
                column: "SocialPayoutId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialPayoutUserCategory_UserCategoriesId",
                table: "SocialPayoutUserCategory",
                column: "UserCategoriesId");

            migrationBuilder.CreateIndex(
                name: "IX_Steps_EstablishmentTypeId",
                table: "Steps",
                column: "EstablishmentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_StepsDocuments_DocumentId",
                table: "StepsDocuments",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_Vacancies_EstablishmentId",
                table: "Vacancies",
                column: "EstablishmentId");
